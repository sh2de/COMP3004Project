...
public class DeckFactory{
    ...
    public Deck CreateDeck(boolean mode){
        ...
        if(mode){
            ...
            deck.AddCard(new Card("Generic Foe", "FOE", 1, url, game, new FoeGeneric()));
            deck.AddCard(new Card("Generic Ally", "ALLY", 1, url, game, new AllyGeneric()));
            deck.AddCard(new Card("Generic Weapon", "WEAPON", 1, url, game, new WeaponGeneric()));
        }
